...
import {
    GtnTimeSheetService, GtnJobCodeService, UserService,
    GtnTimeSheetReportService, EmployeeService, FiscalYearService,
    CommonService
} from '../../services/BaseService';
import {
    IGtnTimeSheet, IGtnJobCode, IUser,
    IEmployee, IFiscalYear, IPagination,
    IODataResult, IFGetTimeSheetReport_Result, IFGetTimeSheetDayWiseReport_Result
} from '../../models/Models';
...
@Component({
    templateUrl: 'gtnTimeSheetReport.component.html'
})
export class GtnTimeSheetReportComponent {

    isDisable: boolean;
    userId: string;
    displayTimeList: IGtnTimeSheet[] = [];
  ...
  @ViewChild('modal', { static: false })
    ...
    constructor(
        ...
        public gtnTimeSheetReportSheet: GtnTimeSheetReportService,
    ...
    public onFilter() {
        //this.filterByStaff=this.filterByStaff == null ? -1 : this.filterByStaff;
        //this.filterByJobCode=this.filterByJobCode == null ? -1 : this.filterByJobCode;
        if (this.userDetails.Employee.ReportTo[0].ReportTo1 == 0 && this.userDetails.MenuTemplate.MenuVsTemplate.filter(x => x.MenuId == 1048).length > 0) {
            if (this.filterByStaff != null && this.filterByJobCode == null && this.filterByFiscalYear != null) {
                this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportMonthWise(this.pagination, -1, this.filterByFiscalYear, this.filterByStaff, -1)
            ...
            if (this.filterByStaff == null && this.filterByJobCode != null && this.filterByFiscalYear != null) {
                this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportMonthWise(this.pagination, -1, this.filterByFiscalYear, -1, this.filterByJobCode)
                    .subscribe((data: IODataResult<IFGetTimeSheetReport_Result[]>) => {
                        this.timeListMonthWise = data.value;
                        this.pagination = {
                            ItemsPerPage: this.pagination.ItemsPerPage,
            ...
            if (this.filterByStaff != null && this.filterByJobCode != null && this.filterByFiscalYear != null) {
                this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportMonthWise(this.pagination, -1, this.filterByFiscalYear, this.filterByStaff, this.filterByJobCode)
                    .subscribe((data: IODataResult<IFGetTimeSheetReport_Result[]>) => {
                        this.timeListMonthWise = data.value;
                        this.pagination = {
                            ItemsPerPage: this.pagination.ItemsPerPage,
            ...
            if (this.filterByStaff == null && this.filterByJobCode == null && this.filterByFiscalYear != null) {
                this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportMonthWise(this.pagination, -1, this.filterByFiscalYear, -1, -1)
                    .subscribe((data: IODataResult<IFGetTimeSheetReport_Result[]>) => {
                        this.timeListMonthWise = data.value;
                        this.pagination = {
                            ItemsPerPage: this.pagination.ItemsPerPage,
            ...
            if (this.filterByStaff != null && this.filterByJobCode == null && this.filterByFiscalYear != null) {
                this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportMonthWise(this.pagination, this.currentEmpId, this.filterByFiscalYear, this.filterByStaff, -1)
                    .subscribe((data: IODataResult<IFGetTimeSheetReport_Result[]>) => {
                        this.timeListMonthWise = data.value;
                        this.pagination = {
                            ItemsPerPage: this.pagination.ItemsPerPage,
            ...
            if (this.filterByStaff == null && this.filterByJobCode != null && this.filterByFiscalYear != null) {
                this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportMonthWise(this.pagination, this.currentEmpId, this.filterByFiscalYear, -1, this.filterByJobCode)
                    .subscribe((data: IODataResult<IFGetTimeSheetReport_Result[]>) => {
                        this.timeListMonthWise = data.value;
            ...
            if (this.filterByStaff != null && this.filterByJobCode != null && this.filterByFiscalYear != null) {
                this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportMonthWise(this.pagination, this.currentEmpId, this.filterByFiscalYear, this.filterByStaff, this.filterByJobCode)
                    .subscribe((data: IODataResult<IFGetTimeSheetReport_Result[]>) => {
                        this.timeListMonthWise = data.value;
                        this.pagination = {
                            ItemsPerPage: this.pagination.ItemsPerPage,
            ...
            if (this.filterByStaff == null && this.filterByJobCode == null && this.filterByFiscalYear != null) {
                this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportMonthWise(this.pagination, this.currentEmpId, this.filterByFiscalYear, -1, -1)
                    .subscribe((data: IODataResult<IFGetTimeSheetReport_Result[]>) => {
                        this.timeListMonthWise = data.value;
                        this.pagination = {
                            ItemsPerPage: this.pagination.ItemsPerPage,
    ...
    public getJobCodeId(data: any): Promise<IGtnJobCode[]> {
        return new Promise<IGtnJobCode[]>((resolve) => {
            let jobQuery = `$filter=JobCode1 eq '${data}'`;
            this.jobCodeService.getAll(jobQuery).subscribe((data: IGtnJobCode[]) => {
                resolve(data);
            });
        });
    }
                        ...
                        .subscribe((sData: Date) => {
                            ...
                            this.commonService.GetConvertedDateAD(fiscalYear, fiscalMonth, fiscalEndDay)
                                .subscribe((edata: Date) => {
                                    ...
                                    this.gtnTimeSheetReportSheet.GetGtnTimeSheetReportDayWise(eventDetail.EmployeeId, eventDetail.JobCodeId, startDate, endDate)
        ...
        this.commonService.GetConvertedDateAD(this.remarksYear, this.remarksMonth, remarksDay)
            .subscribe((data: Date) => {
                ...
                this.userService.getAll(query).subscribe((list: IUser[]) => {
                    ...
                    let tmQuery = `$filter=JobCode eq ${jobCodeId} and PostedBy eq '${userId}' and Date eq datetime'${convertedDate}'`;
                    this.timeSheetService.getAll(tmQuery).subscribe((tmList: IGtnTimeSheet[]) => {
                        this.remarksList = [];
                        tmList.forEach(item => {
                            this.remarksObj = {
                                hour: item.Hour,
    ...
    //public exportToPDF(timeSheetList: IFGetTimeSheetReport_Result[]) {
    //    let dataList: any = [];
    //    let FileName: string = "";
    ...
    //    //        return true;
    //    //    },
    //    //    '.controls': function (element:any, renderer:any) {
    //    //        return true;
    //    //    }
    //    //};
    ...
    //    //console.log(document.getElementById('monthlyRecordTable'));
    //    //var margins = {
    //    //    top: 25,
    //    //    bottom: 60,
    //    //    left: 20,
