...
@Component({
    selector: 'selectChildCategory',
    templateUrl: 'selectChildCategory.component.html',
    styleUrls: ['selectChildCategory.component.css'],
})
export class SelectChildCategoryComponent implements OnInit {
